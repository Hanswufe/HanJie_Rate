            ...
            public void handleMessage(Message msg) {
                if (msg.what == msgWhat) {
                    ...
                    for(HashMap<String, String> ret : retList){
                        item.setCurName(ret.get("ItemTitle"));
                        item.setCurRate(ret.get("ItemDetail"));
                        rateManager.add(item);
                    }
                    if(rateManager.isExit()){
                        Toast.makeText(getApplicationContext(), "存取完成", Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(getApplicationContext(), "存取失败", Toast.LENGTH_SHORT).show();
                    }
